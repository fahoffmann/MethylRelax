...
if bJomega:
    ...
    if not bHaveDy:
        print_xy(out_pref+'_R1.dat',  sim_resid, datablock[0,:], header=optHeader)
        print_xy(out_pref+'_R2.dat',  sim_resid, datablock[1,:], header=optHeader)
        print_xy(out_pref+'_NOE.dat', sim_resid, datablock[2,:], header=optHeader)
        print_xy(out_pref+'_rho.dat', sim_resid, datablock[3,:])
    else:
        print_xydy(out_pref+'_R1.dat',  sim_resid, datablock[0,:,0], datablock[0,:,1], header=optHeader)
        print_xydy(out_pref+'_R2.dat',  sim_resid, datablock[1,:,0], datablock[1,:,1], header=optHeader)
        print_xydy(out_pref+'_NOE.dat', sim_resid, datablock[2,:,0], datablock[2,:,1], header=optHeader)
